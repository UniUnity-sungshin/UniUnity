...
const storeUploadBtn = document.querySelector('#storeUploadBtn');
const storeName = document.querySelector('#storeName'),
      store_location = document.querySelector('#storeAdr'),
...
function updateStore(){
    ...
    .then((res) => res.json())
    .then(res => {
        console.log("partner store upload.");
    })
}
